...
$(document).ready(function() {
    ...
    var new_month = (((parseInt(month-3))+12)%12).toString();
    if(new_month.length==1){
        new_month = "0"+new_month;
    }

    var from_date = day+"/"+new_month+"/"+year;
...
function draw_insights(data){
    ...
    //console.log(final_labels_graph);
    ...
    Object.keys(data).forEach(function(key){
        ...
        //console.log(current_label, list_data);
        obj["data"] = list_data;
...
$('body').on('click','#submit-analytics',function(){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            //console.log(list_insigths_1, "list_insights_1");
            //console.log(products, "prodcuts");
            //console.log(platforms, "platform");
            //console.log(top_intent_in_entities, "top intent in entities");
            //console.log(top_entities_in_intent, "top entities in intent");
            //console.log(average_session_time, "average session time");
            //console.log(total_unique_users, "total_unique_users");
...
$('body').on('click',"#download-report", function(){
    ...
    var url = '/report/'+from_date+'/'+to_date+'/';
    openInNewTab(url);
});
